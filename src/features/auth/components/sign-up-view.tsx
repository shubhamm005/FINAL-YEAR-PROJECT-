      ...
      <div className='relative hidden h-full flex-col p-10 lg:flex dark:border-r'>
        ...
        <div className='text-sidebar-foreground relative z-20 mt-auto'>
          <blockquote className='space-y-2'>
            <p className='text-lg'>
              &ldquo;Join your department&apos;s dashboard — collaborate with your HOD, manage
              classes, and stay on top of your schedule.&rdquo;
            </p>
            <footer className='text-sidebar-foreground/70 text-sm'>Teacher</footer>
          </blockquote>
        </div>
      </div>
